...
& $compiler /nologo /target:winexe /optimize+ /platform:anycpu /out:"$dist\MigradorSeguro.exe" /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Web.Extensions.dll "$root\src\MigradorSeguro.cs"
