...
- La versión **3.0.1** corrige los enlaces de descarga y reúne los seis paquetes de iconos en la publicación independiente `icon-themes-v1`, para que puedan mantenerse sin incorporarlos al ejecutable.
