...
- La versión **2.3.0-rc.4** presenta Migración, Herramientas, Mochila y Acerca de como pestañas de una sola ventana. Cada sección utiliza un color identificador, la pestaña activa se destaca claramente y las pantallas secundarias adaptan su distribución al espacio disponible. Las confirmaciones, vistas previas y selectores de archivos continúan apareciendo por separado cuando son necesarios para proteger una operación.
